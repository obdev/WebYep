...
// http://www.obdev.at
   ...
   $webyep_sAdminName = "demo";
   $webyep_sAdminPassword = "demo";
	...
	$webyep_aMultiLoginName[] = "demo2";
	$webyep_aMultiLoginPassword[] = "demo2";
	$webyep_aMultiLoginURLPatterns[] = "/webyep_demo/*/events_category.php";
   ...
   $webyep_bLiveDemo = true;
   $webyep_bLiveDemoLockTemplate = true;
