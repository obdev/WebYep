...
<html><head>
	<meta charset="UTF-8">
	<title><?php WYTSD("LongTextEditorTitle", true); ?></title>
	...
	<!--[if lt IE 9]>
	<script src="javasript/html5shiv.js"></script>
	<![endif]-->
	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
		<div id="PageDiv">
			<div id="simplemodal" class="WYsimplemodal">
				<h1 class="simplemodal f-lp"><?php echo WYTS("LongTextEditorTitle"); ?>: <span class="grey"><?php echo $oEditor->sFieldName; ?></span></h1>
				<div id="WebYeplogo">
				...
				<div id="instruction">
					...
					<p class="f-fp f-lp arrowdownafter">Text
						<!-- <img id="arrowdown" src="../resources/arrow-down.png" alt="Text input"> -->
					</p>
				</div>
			</div>
		</div>
