...
a:visited { color:#09c }
a:hover { color:#09c }
.textButton a { -webkit-border-radius:2;
    -moz-border-radius: 2;
    border-radius: 2px;
    color: #ffffff;	
    font-size: 13px;
...
.textButton a:hover { background:#545454;
    text-decoration: none; }
.textButton a:visited { color:#ffffff;
    text-decoration: none; }
...
<body>
<div id="PageDiv">
	<h1><?php echo $webyep_sProductName?> <?php echo WYTS("WebYepNotice");?></h1>
	<h3><?php WYTSD("PermissionErrorTitle") ?></h3>
	<p>T<?php WYTSD("PermissionErrorMessage") ?></p>
