...
<head>
	<meta charset="UTF-8">
	<title><?php WYTSD("ShortTextEditorTitle", true); ?></title>
	...
	input[type=submit]:hover, #logon:hover, #save:hover, .resetButtonClass-Name:hover {
		background-color: #444;
	}
	input[type=submit]:active, #logon:active, #save:active, .resetButtonClass-Name:active {
		background-color: #444;
	}
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
		<div id="PageDiv">0
			<div id="simplemodal" class="WYsimplemodal">
				<h1 class="simplemodal f-lp"><?php echo WYTS("ShortTextEditorTitle")?>: <span class="grey"><?php echo $oEditor->sFieldName; ?></span></h1>
				<div id="WebYeplogo">
				...
				<p class="f-fp f-lp">
			<input type="submit" id="save" class="WYmainbuttons r2 t2" value="<?php WYTSD('SaveButton', true); ?>">
               ...
               <?php echo (new WYEditor())->sHiddenFieldsForElement($oElement); ?>
				...
				<div id="formcontainerinner1">
					<p class="f-fp f-lp arrowdownafter">Text
						<!-- ><img id="arrowdown1" src="../images/arrow-down.png" alt="Text"> -->
					</p>
				</div>
			</div>
		</div>
