  ...
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
    <div id="PageDiv">0
      <div id="simplemodal" class="WYsimplemodal">
        <h1 class="simplemodal f-lp"><?php echo WYTS("ShortTextEditorTitle")?>: <span
            class="grey"><?php echo $oEditor->sFieldName; ?></span></h1>
        <div id="WebYeplogo">
        ...
        <div id="wy-simple-modal-footer" class="WYcenteralign">
          <p class="f-fp f-lp">
            ...
            <input type="button" id="cancel" class="WYmainbuttons r2" value="<?php WYTSD("CancelButton", true); ?>"
              onclick="parent.wySMLink.hide();">
            <?php }elseif($webyep_sModalWindowType == 'jquery'){?>
            <input type="button" id="cancel" class="WYmainbuttons r2" value="<?php WYTSD("CancelButton", true); ?>"
              onclick="parent.wySMLink.hideModal();">
            <?php }
				else{?>
            <input type="button" id="cancel" class="WYmainbuttons r2" value="<?php WYTSD("CancelButton", true); ?>"
