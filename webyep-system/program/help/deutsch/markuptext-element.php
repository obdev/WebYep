...
#textButtonWrap { width:214px; min-height:36px; z-index:0; margin-top:30px; margin-right:auto; margin-bottom:15px }
-->
</style>
<!--[if lt IE 9]>
...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Help: Markup Text</h1>
	<h3>Description</h3>
	<p>A &quot;Markup Text&quot; can be any text intended to be used as code such as in meta or description  tags, this usually consists of a single line of text although complex code such as scripts supplied by Vimeo can be inserted within the Markup Text element. Contrary to the all other Text elements the a Markup Text element is not usualy formatted.</p>
	<h3>Usage</h3>
	<p>Enter your text into the large text field and click &quot;save&quot;.</p>
	<p>The editor window will close after saving and the changed text will be inserted within you web page.<br><span class="remark">In some rare cases you may need to click the &quot;Reload Page&quot; button of your web browser.</span></p>
	<div id="textButtonWrap"><p class="f-fp f-lp"><span class="textButton"><a href="javascript:window.close()%3B">Hilfe schließen</a></span></p>
	</div>
	<hr>
