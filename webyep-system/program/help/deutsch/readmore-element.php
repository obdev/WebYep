...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Hilfe: Read More</h1>
	<h3>Beschreibung</h3>
	<p>Das &quot;Weiterlesen&quot; Element wird verwendet, um editierbare Links am Ende von Produktbeschreibungen oder Anrisstexten zu erzeugen. Texte dieses Elements sind üblicherweise auf wenige Worte beschränkt. Im Gegensatz zum herkömmlichen Text, können beim Weiterlesen-Element keine Formatierungen (Fettschrift, Absätze, etc.) vorgenommen werden.</p>
