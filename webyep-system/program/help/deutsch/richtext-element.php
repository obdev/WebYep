...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Hilfe: Rich Text</h1>
	<h3>Beschreibung</h3>
	<p>Mit dem <?php echo $webyep_sProductName?> HTML-Text-Element können Sie HTML-formatierten Text erstellen.</p>
	<h3>Vorgehensweise</h3>
	<p>Geben Sie den Text und die gewünschten HTML-Formatierungs-Befehle ein und klicken Sie dann auf &quot;Speichern&quot;.</p>
