...
<body>
<div id="PageDiv">
	<h1><?php echo $webyep_sProductName?>  Helpen: Lees Meer</h1>
	<h3>Description</h3>
	...
	<p>The editor window will close after saving and the changed text will appear in you web page.<br><span class="remark">In some rare cases you might need to klick the &quot;Reload Page&quot; button of you web browser.</span></p>
	...
	<hr>
	<p class="f-lp"><?php echo $webyep_sCopyrightLine?></p>
</div>
</body>
</html>
