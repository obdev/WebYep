...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Helpen: Opgemaakte tekst</h1>
	<h3>Omschrijving</h3>
	...
	<p>Het bewerkingsvenster zal sluiten en de gewijzigde tekst zal worden weergegeven in uw webpagina.<br><span class="remark">In sommmige uitzonderlijke gevallen kan het nodig zijn om de pagina in uw brwoser te verversen.</span></p>
