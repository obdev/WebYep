...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Helpen: Korte tekst</h1>
	<h3>Omschrijving</h3>
	<p>Een &quot;Korte tekst&quot; kan elk soort tekst zijn, zoals een titel, een paginakop, een productnaam of een prijs. Het bestaat normaal gesproken uit een enkel woord of korte zin. In tegenstelling tot het Alinea Element staat de opmaak van de Korte tekst vast en is bepaald door de webdesigner.</p>
	<h3>Gebruik</h3>
	<p>Voer de tekst in in het tekstveld en klik op de knop &quot;Bewaar&quot;.</p>
	<p>Het bewerkingsvenster zal sluiten en de gewijzigde tekst wordt zichbaar in de webpagina.<br><span class="remark">In sommmige uitzonderlijke gevallen kan het nodig zijn om de pagina in uw brwoser te verversen.</span></p>
