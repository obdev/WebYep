...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Help: Image</h1>
	<h3>Description</h3>
	<p>With the &quot;Edit Image Window&quot; you can insert images (like fotos or graphics) into your website or remove them again.</p>
	<p><strong>Important: </strong>The image must be stored in an &quot;internet usable&quot; format - which means:</p>
	<ul>
		<li>The image file should be small (max. 100-150 kBytes) and the image should have small dimensions (width and height should not exceed 200-300 pixels).</li>
		<li>The image file format should be one supported by common web browsers (GIF, PNG or JPEG).</li>
	</ul>
	<h3>Usage</h3>
	<p><strong>Change Image:</strong><br>Click the &quot;Browse...&quot; button to choose the image file you want to insert (upload) into your page. Select the image file in the appearing file selection dialog and click &quot;OK&quot; (or &quot;Open&quot;). Then click &quot;Save&quot; to start uploading the image file.</p>
	...
	<p><strong>Delete Image:</strong><br>Click the &quot;Delete&quot; button to remove the image from the page and delete it from the web server.</p>
	<p>After clicking &quot;Delete&quot; or &quot;Save&quot; (after the upload has finished) the editor window will close and the changed page will be displayed.<br><span class="remark">In some rare cases you may need to click the &quot;Reload Page&quot; button of your web browser.</span></p>
