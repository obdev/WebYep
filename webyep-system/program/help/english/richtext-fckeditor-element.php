...
<td align="left" valign="top"><h1><?php echo $webyep_sProductName?> Help: Rich
      Text with FCKeditor Editor</h1></td>
...
<h3>Description</h3>
<p>Using the <strong>FCKeditor</strong> WYSIWYG HTML Editor extension to the <?php echo $webyep_sProductName?> Rich Text field you can create HTML formatted content without needing to enter the HTML code by hand.</p>
<p>The <strong>FCKeditor</strong> editor's capabilities might vary, depending on which web browser you are using.</p>
