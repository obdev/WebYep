...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Help: Short Text</h1>
	<h3>Description</h3>
	<p>A &quot;Short Text&quot; can be any short text element like a headline, product name or price and usually consists of a single line. Contrary to the Long Text Element in a Short Text the formatting is fixed by the web designed.</p>
	<h3>Usage</h3>
