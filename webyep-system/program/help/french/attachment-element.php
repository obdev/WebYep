...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Aide : Téléchargement de fichiers</h1>
	<h3>Description</h3>
	<p>Dans la fenêtre éditer &quot;Télécharger fichier&quot; vous pouvez télécharger des fichiers sur votre site et aussi les supprimer.Usage</p>
	<h3>A procéder comme suit:</h3>
	<p><strong>Modification d'un fichier</strong><br>Allez sur &quot;rechercher...&quot; et choisissez le fichier sur votre PC/Mac et presser OK. Allez ensuite sous enregistrer pour transférer le fichier sur votre page web.</p>
	<p><strong>Avis: </strong><br>La durée du transfert dépend de votre connexion internet.</p>
	<p><strong>Supprimer un fichier:<br></strong>Allez sur &quot;Supprimer&quot; pour supprimer le fichier qui se trouve sur votre serveur. (Le fichier original qui se trouve sur votre PC/Mac ne sera pas supprimé).</p>
	<p>La fenêtre se ferme après l'enregistrement et votre page web modifiée apparaît.<br>(Dans de rares cas vous devez actualiser votre navigateur pour voir les modifications)u web page.</p>
