...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Aide : Texte HTML</h1>
	<h3>Description</h3>
	<p>Avec l'élément Texte-HTML de <?php echo $webyep_sProductName?> vous pouvez formater du texte HTML.</p>
	<h3>A procéder comme suit:</h3>
	<p>Insérez votre texte ainsi que les commandes HTML et cliquez sur &quot;Enregistrer&quot;</p>
