...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Aide : Texte court</h1>
	<h3>Description</h3>
	<p>Avec &quot;Textes courts&quot; nous entendons les petits textes comme par exemple, Titres, Produits, Prix, etc... Les textes courts sont normalement sur une seule ligne. Au contraire des textes normaux, les textes courts ne peuvent êtres formatés en détails (Gras, paragraphe, etc.).</p>
	<p><strong>A procéder comme suit :<br></strong>Insérez le texte dans le champ de texte et cliquer sur &quot;Enregistrer&quot;</p>
