...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Ayuda: <span class="style3">Acceso</span></h1>
	<h3>Indicaciones</h3>
	<p>Para editar el contenido de tu página web, es necesario acceder al sistema WebYep introduciendo <strong>nombre de usuario</strong> y <strong>contraseña</strong> correctamente.</p>
	<p>Por favor, consulta a tu diseñador web (<em>la persona que haya realizado tu página web</em>) para que te facilite el nombre de usuario y contraseña.<br>
O revisa la documentación para diseñadores web (&quot;<em>Instalación en servidor web / Configuración</em>&quot;) sobre cómo configurar el nombre de usuario y la contraseña.</p>
	...
	<hr>
	<p class="f-lp"><span class="Nota"> <?php echo $webyep_sCopyrightLine?> </span></p>
</div>
</body>
</html>
