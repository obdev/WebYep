...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Ayuda: ¡No está configurado correctamente!</h1>
	<!-- <h3>Descripción</h3> -->
	...
	<p>Por favor, contacta con el diseńador web que ha realizado tu página web para recibir asistencia sobre &quot;configuración&quot;<?php echo $webyep_sProductName?>.</p>
