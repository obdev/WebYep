...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Ayuda: Imagen</h1>
	<h3>Descripción</h3>
	<p>En la ventana &quot;Editar imagen&quot; puedes añadir imágenes<em> (fotografías o gráficos)</em> a tu págna web y también eliminarlas. </p>
	<p><strong>Importante:<br></strong>La imagen debe haberse guardado con un &quot;formato adecuado para internet&quot;, es decir:</p>
	<ul>
		<li>El peso o tamaño de la imagen debe ser preferiblemente bajo<em> (200 kBytes)</em> y tener pequeñas dimensiones (por ejemplo, que el alto y el ancho no excedan de 1000 pixels).</li>
	...
	<p><strong>Borrar imagen:</strong><br>Haz click sobre el botón &quot;Eliminar&quot; para eliminar la imagen de la página web y borrarla en el servidor web.</p>
	<p>Después de pulsar &quot;Eliminar&quot; or &quot;Guardar&quot; (una vez la carga de la imagen haya finalizado) la ventana del editor se cerrará y la página web mostrará los cambios realizados.<br><span class="remark">En algunos casos puede ser necesario que hagas click sobre el botón &quot;Actualizar página&quot; de tu navegador para ver los cambios realizados.</span></p>
