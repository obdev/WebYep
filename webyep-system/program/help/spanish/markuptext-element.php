...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Ayuda:Lenguaje de marcado</h1>
	<h3>Descripción</h3>
	<p>El &quot;Lenguaje de marcado&quot; puede ser cualquier texto destinado a ser utilizado como código, como en etiquetas meta o de descripción. Aunque normalmente consta de una sola linea de texto, códigos más complejos como los que proporciona Vimeo pueden insertarse en la página web mediante el elemento Lenguaje de marcado. Al contrario que otros elementos de texto, el elemento Lenguaje de marcado no está habitualmente formateado.</p>
	<h3>Indicaciones</h3>
	<p>Introduce el texto en el campo grande de texto y haz click sobre el botón &quot;Guardar&quot;.</p>
	...
	<div id="textButtonWrap"><p class="f-fp f-lp"><span class="textButton"><a href="javascript:window.close()%3B">Cerrar ventana</a></span></p>
	</div>
	<hr>
