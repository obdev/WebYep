...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Ayuda: Leer más</h1>
	<h3>Descripción</h3>
	<p>El elemento &quot;Leer más&quot; se utiliza para personalizar links que dirigen a una lectura ampliada al final de una descripción de producto o textos de presentación. Normalmente este texto es de unas pocas palabras. El formato está fijado por el diseñador web.</p>
	<h3>Indicaciones</h3>
	<p>Introduce tu texto en el campo de texto y haz click sobre el botón &quot;Guardar&quot;.</p>
