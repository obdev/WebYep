...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Ayuda: Texto Enriquecido</h1>
	<h3>Descripción</h3>
	<p>Puedes usar el campo de Texto Enriquecido de <?php echo $webyep_sProductName?> para insertar texto formateado utilizando código HTML.</p>
	<h3>Indicaciones</h3>
	<p>Introduce el texto (incluyendo el código HTML respecto al formato) y haz click sobre el botón &quot;Guardar&quot;.</p>
