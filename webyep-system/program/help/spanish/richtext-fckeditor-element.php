...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Ayuda: Texto Enriquecido con Editor FCKeditor</h1>
	<h3>Descripción</h3>
<p>Usando la extensión de edición WYSIWYG HTML <strong>FCKeditor</strong> sobre el campo de Texto Enriquecido de <?php echo $webyep_sProductName?>, puedes crear contenido formateado con HTML sin necesidad de escribir ningún código HTML.</p>
<p>Las capacidades del Editor <strong>FCKeditor</strong> podrían verse alteradas, dependiendo de qué navegador estés empleando.</p>
...
<h3>Indicaciones</h3>
<p>Introduce el texto, utiliza las opciones del editor para formatear el texto, y haz click sobre el botón &quot;Guardar&quot; button.</p>
