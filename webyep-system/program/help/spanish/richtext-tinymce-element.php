...
<tr>
<td align="left" valign="top"><h1><?php echo $webyep_sProductName?> Ayuda: Texto Enriquecido con Editor TinyMCE</h1></td>
...
<h3>Descripción</h3>
<p>Usando la extensión de edición WYSIWYG HTML <strong>TinyMCE</strong> sobre el campo de Texto Enriquecido de <?php echo $webyep_sProductName?>, puedes crear contenido formateado con HTML sin necesidad de escribir ningún código HTML.</p>
<p>Las capacidades del Editor  <strong>TinyMCE</strong> podrían verse alteradas, dependiendo de qué navegador estés empleando.</p>
