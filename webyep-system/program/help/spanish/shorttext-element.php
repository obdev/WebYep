...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Ayuda: Texto Breve</h1>
	<h3>Descripción</h3>
	<p>Un &quot;Texto Breve&quot; puede ser cualquier elemento breve de texto como un titular, nombre de producto o precio, y normalmente consta de una sóla linea. Al contrario que en el elemento Texto de Párrafo, el formato de un Texto Breve está fijado por el diseñador web.</p>
	<h3>Indicaciones</h3>
	<p>Introduce el texto y haz click sobre el botón &quot;Guardar&quot;.</p>
