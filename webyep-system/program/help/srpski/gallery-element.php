...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Pomoc: Galerija</h1>
	<h3>Opis</h3>
	<p>U prozoru &quot;Foto&quot; mozete graficke fajlove da postavite na foto galeriju svog web sajt,odnosno da ih sa nje skidate.</p>
	<p><strong>Vazno:<br></strong>Graficki fajl koji zelite da postavite na svoj web sajt mora da odgovara zahtevima interneta. Znaci:</p>
	<ul>
		<li>Ne treba da bude <strong>preveliki</strong>, u odnosu na <strong>dimenzije</strong> (sirina i visina) kao <strong>i velicinu fajla</strong>.Visina odnosno sirina od maksimalno 600 piksela, kao i velicina fajla od maksimalno 300kB (kilobajta) bi trebali da budu apsolutna gornja granica.</li>
		<li>Trebao bi da bude u nekom od <strong>formata</strong> koje svaki Browser moze da prikaze, kao na primer GIF ili JPG (odnosno JPEG). Mogucnosti Browser-a se stalno unapredjuju, tako da su i drugi formati zamislivi - konsultujte svog web dizajnera po tom pitanju.</li>
	</ul>
	<p>Sistem izuracunava automatski jednu mini verziju slike (Thumbnail), koja ce biti prikazana u pregledu.</p>
	<h3>Postupak</h3>
	<p><strong>Promena grafickog fajla:<br></strong>Kliknite na &quot;pretrazi...&quot; i izaberite zeljeni MP3-fajl sa Vaseg hard diska. Kliknite onda na dugme za cuvanje i prebacite fajl na Vas web sajt.</p>
	<p><strong>Pojasnjenje: </strong><br>Prebacivanje fajlova na Vas web sajt moze da potraje, zavisno od toga kakva vam je internet konekcija.</p>
	<p>Posle cuvanja se prozor za upisivanje zatvara i mozete da vidite svoj promenjeni web sajt.<br><span class="remark">(u retkim slucajevima morate u Browser-u da aktuelizujete svoj sajt)</span></p>
