...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Pomoc: Kratki Tekst</h1>
	<h3>Opis</h3>
	<p>Pod kratkim tekstom se podrazumevaju kraci delovi teksta kao sto su naslovi, oznake za proizvode ili cene. Kratki tekstovi su obicno jednoredni. Kod kratkog teksta nije moguce formatiranje, kao kod uobicajenog teksta.</p>
	<h3>Obs&#322;uga</h3>
	<p>Upisite zeljeni tekst u za ot predvidjeno polje i kliknite na &quot;sacuvaj&quot;.</p>
	<p>Posle klika na &quot;sacuvaj&quot; se prozor za upisivanje zatvara i mozete da vidite svoj web sajt sa promenjenim tekstom.<br><span class="remark">(u retkim slucajevima morate u Browser-u da aktuelizujete svoj sajt).</span></p>
