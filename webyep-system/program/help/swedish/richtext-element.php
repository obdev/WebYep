...
<body>
<div id="PageDiv">
	<h1> <?php echo $webyep_sProductName?> Hjälp : Formaterad text</h1>
	<h3>Description</h3>
	<p>Använd <?php echo $webyep_sProductName?> Rich Text-fältet för att lägga till formaterad text med HTML-kod.</p>
	<h3>Gör så här</h3>
	<p>Skriv in önskad text (inklusive ev HTML-kod) och klicka Spara.</p>
	<p>Redigeringsfönstret stängs och texten visas på webbsidan. <br>I enstaka fall kan du behöva ladda om sidan manuellt innan ändringen syns.</p>
