...
<tr>
<td align="left" valign="top"><h1><?php echo $webyep_sProductName?> : formaterad text (rich
    text) med  FCKeditor Editor</h1></td>
...
<p>Anv&auml;nd <strong>FCKeditor</strong> WYSIWYG HTML-redigering tillsammans med
  <?=$webyep_sProductName?>
Rich Text-f&auml;ltet och du kan formatera texten  utan att beh&ouml;va skriva HTML-kod f&ouml;r hand. </p>
<p>Funktionerna i <strong>FCKeditor</strong> kan variera beroende p&aring; den  webbl&auml;sare du anv&auml;nder. </p>
...
<p>Skriv in din text och anv&auml;nd knapparna i<strong> FCKeditor </strong>f&ouml;r att formatera texten. Klicka sen Spara.</p>
