...
<body>
<div id="PageDiv">
	<h1><span class="style3">Logowanie <?php echo $webyep_sProductName?></span></h1>
	<h2>WebYep - Zgrabny, lśniący System Zarządzania Treścią CMS</h2>
	<p>WebYep jest kompaktowym CMS'em, w ktrórym tworzenie edytowalnych stron internetowych jest bardzo szybkie i proste. W odróżnieniu od większych systemów CMS, WebYep jest ekonomiczą alternatywą dla mniejszych stron.. WebYep jest idealnym rozwiązaniem dla webmasterów nie mających ochoty na zagłebianie się w sktypty serwerowe PHP, a jedynie chcą stworzyć zarządzalną stronę przy pomocy prostego narzędzia.</p>
	<h3><span class="RED">Aby edytować strony w WebYep porzebna jest włączona w przeglądarce obsługa JavaScript!</span></h3>
	<div id="textButtonWrap" class="f-ms"><p class="f-fp f-lp"><span class="textButton"><a href="javascript:window.history.back()%3B">Poprzednia Strona</a></span></p>
	</div>
	<hr>
