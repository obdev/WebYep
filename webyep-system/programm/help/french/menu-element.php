...
<p>Please remind that all changes are not applied to the page until you click the &quot;Save&quot; [12] button but <strong>then can not be undone!</strong></p>
  ...
  <tr>
    <td><strong>A brief description of the user interface:</strong>
      <ol>
        ...
        <li>Optional input field 'Link': you may enter the address of another site here</li>
        <li>Checkbox to control visibility of the menu entry (and all it's descendants)</li>
        <li>Arrow buttons to move an entry</li>
        <li>Add new menu item (same level as current entry)</li>
        <li>Add new submenu entry (submenu of the current entry)</li>
    ...
    <td>
      <p align="center"><img src="../english/images/menu-editor-detail.png" width="495" height="434"><br>
...
<p>When you click an entry in the main view [2], the details for this entry are shows in the input fields to the right [3,4,5]. The current entry will be highlighted in the mein view [2] and all actions will refer to this entry.</p>

<h4>Add menu item</h4>
<p>To add a menu item, click the 'Add Menu Item' [7], or 'Add Submenu Item' [8] button. A new menu item will be inserted below the current item. This new item will be selected and can be edited now.</p>
...
Note that the item will not really be deleted until you safe the menu by clicking the &quot;Save&quot; button.</p>
