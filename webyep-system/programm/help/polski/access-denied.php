...
<tr>
<td align="left" valign="top"><h1><?php echo $webyep_sProductName?> Pomoc: Logowanie</h1></td>
...
<p>Aby rozpocz±æ edycjê tre¶ci musisz siê zalogowaæ w <?php echo $webyep_sProductName?> CMS
	 u¿ywaj±c <strong> nazwy u¿ytkownika i has³a</strong>.</p>
<p>Zg³o¶ siê do administratora strony aby otrzymaæ nazwê i has³o.</p>
<p>Je¶li jeste¶ twórc± tej strony zobacz dokumentacjê dla administratorów (&quot;Intalacja na serwerze /
	 Konfiguracja&quot;) aby dowiedzieæ siê jak stworzyæ nazwê i has³o.</p>
